export const CommonEn = {
  ...
  View_Log_And_Score: 'View Log and Score',
  View_Detailed_Score: 'View Detailed Score',
  ...
  Expand: 'Expand',
  Parameter: 'Parameter',
  Name_Must_Be_Alphanumeric: 'Name must be letters, numbers or underscores, and use underscores to separate multiple words',
  Title: 'Title',
  Value: 'Value',
  Advanced: 'Advanced',
  Related_Questions: 'Related Questions',
  Please_Input_Question: 'Please input question',
  Output_verification_success: 'Output verification successful',
